...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'payment_id', 'log_at', 'message' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\PaymentLogs\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\PaymentLogs\Definitions::softDeleteColumn();
