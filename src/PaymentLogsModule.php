...
final class PaymentLogsModule implements ModuleInterface
{
    public function name(): string { return 'table-payment_logs'; }
    public function table(): string { return 'payment_logs'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-payments' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_payment_logs_payment' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_payment_logs_payment' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_payment_logs_payment' ],
            'foreignKeys' => [ 'fk_payment_logs_payment' ],
        ];
    }
}
