...
namespace BlackCat\Database\Packages\PaymentLogs\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO PaymentLogDto:
...
final class PaymentLogDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'payment_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'log_at' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): PaymentLogDto
    {
        /** @var PaymentLogDto */
    ...
    public static function fromRowOrNull(?array $row): ?PaymentLogDto
    {
     ...
     *
     * @param PaymentLogDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(PaymentLogDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(PaymentLogDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(PaymentLogDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,PaymentLogDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,PaymentLogDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(PaymentLogDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,PaymentLogDto>
     */
