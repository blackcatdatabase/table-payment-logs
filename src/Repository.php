...
use BlackCat\Database\Packages\PaymentLogs\Repository\PaymentLogRepositoryInterface;
use BlackCat\Database\Packages\PaymentLogs\Repository\PaymentLogRepository as GeneratedRepository;
...
{
  private PaymentLogRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof PaymentLogRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected PaymentLogRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PaymentLogs\Dto\PaymentLogDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PaymentLogs\Dto\PaymentLogDto|null { return $this->repo->getById($id, $asDto); }
