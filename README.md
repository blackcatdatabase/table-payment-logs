...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 1 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\payment-logs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\payment-logs)
...
graph LR
  ...
  payment_logs["payment_logs"]:::center
  payment_logs -->|FK| payments["payments"]:::link
...
- `log_at` – default=CURRENT_TIMESTAMP(6)
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package payment-logs -Apply
