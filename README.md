...
| Pkg folder | [packages/payment-logs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/payment-logs) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package payment-logs -Apply
